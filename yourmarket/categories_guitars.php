...
<html>
	...
	<body>
		...
		if($connected!=0){
			$sql = "SELECT * FROM item WHERE  category='Guitar' AND commandid IS NULL AND sellerid <>'".$connected."'";
		}else{
			$sql = "SELECT * FROM item WHERE commandid IS NULL AND category='Guitar'";
		}
